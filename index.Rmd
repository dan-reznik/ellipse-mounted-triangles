...
The study of loci of triangle centers (and associated objects) over 1d triangle families is a vast, classic subject. A tiny sample of recent, important works include: [@dykstra2006-loci], [@odehnal2011-poristic], [@pamfilos2020-euler], [@sergei2016-com], but their are many many others.

As a small contribution to this field, we have been constructing a web-based [locus app](https://dan-reznik.github.io/ellipse-mounted-loci-p5js/) geared at visualization and experimentation with loci of triangle families. The figure below shows an example of what can be obtained. To see it live click [here](https://bit.ly/3h2wXZ1):

```{r,out.width="80%"}
knitr::include_graphics("pics/X135 loci.png")
```

We got started after seeing this intriguing construction for the [Right Strophoid Curve]([https://mathcurve.com/courbes2d.gb/strophoiddroite/strophoiddroite.shtml) [@odehnal2015-conics], on Robert Ferréol's wonderful [Mathcurve](https://mathcurve.com/index.htm) portal: such a curve is the locus of the Orthocenter $X_4$ of a triangle with two stationary vertices $V_1,V_2$ and a 3rd one $P(t)$ which is slid along the circle centered on $V_1$ and of radius $r=|V_2-V_1|$:
