...
This page contains information about our [locus app](https://dan-reznik.github.io/ellipse-mounted-loci-p5js/) under construction. This is an improvement upon a [earlier app](https://editor.p5js.org/dreznik/full/i1Lin7lt7). The figure below can be observed by clickling [here](https://dan-reznik.github.io/ellipse-mounted-loci-p5js/?sc=5.587&a=1.592&lc2=trilins&lc3=trilins&Xn1=135&Xn2=135&Xn3=135&tr1=orthic&tr2=orthic&tr3=orthic&dr1=false&mt1=fs&mt2=major&mt3=minor).
...
Note that the cevian, anticevian, pedal, and antipedal triangles are parametrized by an additional triangle center $X_k$.

## Derived circles

One is also able to superimpose a derived circle (see list below) on top of any triangle families drawn. Furthermore one can also *invert* any triangle center with respect to the selected circle.
